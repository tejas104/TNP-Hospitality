...
// Genie timing follows the user's 2026-09-21 direction: open and close were
// both halved in speed (720->1440ms, 620->1240ms) for the client demo.
export const LAUNCHER_TIMING = { open: 1440, close: 1240 } as const;
