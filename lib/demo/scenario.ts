...
export function createScenarioRecords(): ScenarioRecords {
  return {
    ...
    assignments: [
      { id: 'tnp-demo-assignment-001', eventId: 'tnp-demo-event-001', positionId: 'tnp-demo-position-001', workerId: 'tnp-demo-worker-001', response: 'coming', allocationState: 'active', createdAt: PREVIEW_CLOCK },
      { id: 'tnp-demo-assignment-002', eventId: 'tnp-demo-event-001', positionId: 'tnp-demo-position-001', workerId: 'tnp-demo-worker-002', response: 'pending', allocationState: 'active', createdAt: PREVIEW_CLOCK },
      { id: 'tnp-demo-assignment-003', eventId: 'tnp-demo-event-002', positionId: 'tnp-demo-position-002', workerId: 'tnp-demo-worker-003', response: 'not-coming', allocationState: 'active', createdAt: PREVIEW_CLOCK },
      { id: 'tnp-demo-assignment-004', eventId: 'tnp-demo-event-001', positionId: 'tnp-demo-position-003', workerId: 'tnp-demo-worker-005', response: 'coming', allocationState: 'active', createdAt: PREVIEW_CLOCK },
    ],
    attendances: [
    ...
    earnings: [
      { id: 'tnp-demo-earning-001', assignmentId: 'tnp-demo-assignment-001', workerId: 'tnp-demo-worker-001', grossPaise: 250000, deductionsPaise: 25000, netPaise: 225000, proposedTaxLabel: 'Proposed preview deduction', status: 'draft' },
      { id: 'tnp-demo-earning-002', assignmentId: 'tnp-demo-assignment-003', workerId: 'tnp-demo-worker-003', grossPaise: 0, deductionsPaise: 0, netPaise: 0, proposedTaxLabel: 'No proposed deduction', status: 'draft' },
    ],
    payouts: [
      { id: 'tnp-demo-payout-001', month: '2026-09', earningIds: ['tnp-demo-earning-001'], totalPaise: 225000, status: 'processing' },
      { id: 'tnp-demo-payout-002', month: '2026-08', earningIds: [], totalPaise: 0, status: 'uncertain' },
      { id: 'tnp-demo-payout-003', month: '2026-07', earningIds: [], totalPaise: 0, status: 'failed' },
      { id: 'tnp-demo-payout-004', month: '2026-06', earningIds: [], totalPaise: 0, status: 'reversed' },
      { id: 'tnp-demo-payout-005', month: '2026-05', earningIds: [], totalPaise: 180000, status: 'paid' },
    ],
    quotes: [
