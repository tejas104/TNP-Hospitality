...
Current completion target from 2026-09-20: finish the non-homepage UI/frontend to approximately 90%. Operationally, target at least 17 of F02-F20 as independently frontend-ready. F01 and all homepage redesign/refinement are excluded from this program, not deferred to its end. This is a UI/frontend measure, not production capability.
