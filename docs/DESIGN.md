...
## Preserve
Client-selected primary teal #008080, dark teal #062b29, ivory #f5f1e7 and champagne #bba879; existing Georgia display and Manrope/Inter system body stack. `#008080` is the semantic primary/action colour; dark teal remains available for premium deep surfaces and text contrast. Migrate through shared tokens and verified feature adoption rather than replacing every teal-like literal indiscriminately.
