...
| **6–8 — Sep 23–25** | **H1:** basic RSVP/vendor/customer workspace, guest import/validation, function-wise responses, manual follow-up, approved public/content work and truthful provider-disabled states. **H2/C:** freelancer application/assessment, opportunity/claim/Coming/briefing, then pass/attendance/earnings/payout/ratings where contracts are ready. Production services must enforce organization/role boundaries and mutation invariants. | Two-vendor isolation probes; import replay/row-error tests; C capacity/eligibility/overlap tests; attendance evidence; payout/earning derivation; responsive/keyboard flows. |
