...
Absolute worktree: D:\TNP-worktrees\TNP-D-03 (proposed, not created or verified).
...
Dependencies: TNP-D-02. Verify all transitive prerequisite commits through that dependency; never depend on this task itself.
...
Risk: Financial integrity; independent Sol REQUIRED even for preview semantics.
